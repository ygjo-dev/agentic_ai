...
# 겹침 0 은 dev/tests/app/ui/graph_svg/test_nodes_do_not_overlap.py 가 지킨다.
...
# 이 이름을 읽는 쪽은 app/ui/components/flow.py 다. 두 곳이 어긋나지 않게
# dev/tests/app/ui/test_path_flow_document.py 가 같은 값인지 지킨다.
FLOW_CLASS = "flow"
