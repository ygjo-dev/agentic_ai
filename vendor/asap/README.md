...
```
from app.config import settings              → from vendor.asap.config import settings
from app.core.command_renderer import …      → from vendor.asap.command_renderer import …
from app.core.mcp_result_inspector import …  → from vendor.asap.mcp_result_inspector import …
from app.core.mcp_client import …            → from vendor.asap.mcp_client import …
from app.core.isochrone_geometry import …    → from vendor.asap.isochrone_geometry import …
from app.schemas.chat import Command         → from vendor.asap.schemas_chat import Command
