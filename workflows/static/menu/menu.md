...
| Recipe ID | 기능 |
| --- | --- |
| recipe_001 | 말한 장소로 장소 이름으로 좌표와 지도 범위를 찾는다. |
| recipe_002 | 말한 장소로 장소 이름으로 좌표와 지도 범위를 찾고 지도 범위 안의 CCTV 목록을 조회한다. |
...
말한 장소로 장소 이름으로 좌표와 지도 범위를 찾고 지도 범위 안의 CCTV 목록을 조회한다.
