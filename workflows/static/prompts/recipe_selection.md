...
- reason 다음 argument 를 쓴다. 발화가 무엇으로 시작하느냐에 따라 뽑을 것이 다르다.
...
- 뽑을 것이 없으면 null 을 쓴다.
- argument 다음 travel_mode 와 minutes 를 쓴다. 발화가 말한 것만 쓰고 나머지는 null 이다.
    travel_mode  도보 · 자전거 · 승용차 · 대중교통 중 뜻이 맞는 하나
    minutes      "20분" -> [20], "15분, 30분, 60분" -> [15, 30, 60]
    admin_level  발화가 가리킨 행정구역 층위. 시도 · 시군구 · 읍면동 중 하나
