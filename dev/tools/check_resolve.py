...
UTTERANCES = [
    ...
    (32, "지금 보이는 범위 행정경계 그려줘", {"recipe_024"}, True),  # 옛 상대 025 를 지워 이제 겹치는 상대가 없다
    (33, "지금 보이는 데 CCTV 다 띄워줘", {"recipe_026"}, True),  # 보이는 범위 → CCTV
    (34, "지금 보이는 데 철도 노선 뭐뭐 있어", {"recipe_027"}, True),  # 003 은 이름을 대야 하고 여기는 화면이라 갈린다
    (35, "지금 보이는 데 의원 공약 검색해줘", {"recipe_029"}, True),  # 옛 상대 028 을 지워 이제 겹치는 상대가 없다
    (36, "현재 화면 인구 알려줘", {"recipe_031"}, True),  # 보이는 범위 → 인구 통계
    (37, "지금 보이는 데 충전소 충전기 비었는지 알려줘", {"recipe_056"}, True),  # 함께 걸림 052. 사슬 셋
