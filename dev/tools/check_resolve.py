...
UTTERANCES = [
    ...
    (24, "여기 어느 동이야", {"recipe_018"}, True),  # 찍은 지점 → 지점 행정구역 판별
    (25, "여기 CCTV 띄워줘", {"recipe_019"}, True),  # 함께 걸림 026. 「여기」가 지점인지 화면인지 발화에 답이 없다
    (26, "여기 선거구 이름 뭐야", {"recipe_020"}, True),  # 「이름」만 물어 021 · 022 에서 갈린다
    (27, "여기 국회의원 누구야", {"recipe_021"}, True),  # 찍은 지점 → 지점 전체 선거구 판별
    (28, "여기 의원 공약 보여줘", {"recipe_022"}, True),  # 찍은 지점 → 지점 선거구 공약
    (29, "여기 연령대별 인구 알려줘", {"recipe_054"}, True),  # 사슬 셋 — 찍은 지점에서 출발하는 3단을 이 줄이 지킨다
    (30, "여기 인구 변화 알려줘", {"recipe_055"}, True),  # 사슬 셋 — 마지막이 인구 추세
    ...
    (31, "지금 보이는 범위 행정경계 그려줘", {"recipe_024"}, True),  # 옛 상대 025 를 지워 이제 겹치는 상대가 없다
    (32, "지금 보이는 데 CCTV 다 띄워줘", {"recipe_026"}, True),  # 보이는 범위 → CCTV
    (33, "지금 보이는 데 철도 노선 뭐뭐 있어", {"recipe_027"}, True),  # 003 은 이름을 대야 하고 여기는 화면이라 갈린다
    (34, "지금 보이는 데 의원 공약 검색해줘", {"recipe_029"}, True),  # 옛 상대 028 을 지워 이제 겹치는 상대가 없다
    (35, "현재 화면 인구 알려줘", {"recipe_031"}, True),  # 보이는 범위 → 인구 통계
    (36, "지금 보이는 데 충전소 충전기 비었는지 알려줘", {"recipe_056"}, True),  # 함께 걸림 052. 사슬 셋
