...
UTTERANCES = [
    ...
    # 함께 걸림 033 · 024. 033 과 갈리는 근거는 「세종시가 행정구역 이름이다」
    # 뿐인데 그 규칙은 사용자에게 안 보인다.
    # ★ 옛 상대 006(VWorld)은 이번에 지웠다
    (5, "세종시 행정경계 보여줘", {"recipe_005"}, True),
    ...
    # 그 말이 없다. ev.searchStations(query=탄방) 18건(실측)
    (22, "탄방동 충전소 충전기 비었는지 알려줘", {"recipe_052"}, True),
