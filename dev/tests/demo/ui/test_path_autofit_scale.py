"""대상 : demo/ui/components/zoom.py 의 MAX_SCALE · FIT_PAD — 값이 칸에 드는가
...
from demo.api.services import ontology_service, render_service
from demo.graph_svg.dot import FLOW_CLASS
