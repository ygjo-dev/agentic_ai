"""대상 : app/ui/graph_svg/graphviz.py — render_svg()
...
from app.ui.graph_svg.graphviz import GraphvizFailed, GraphvizNotFound, render_svg
...
def test_missing_dot_binary_raises_not_found(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.ui.graph_svg.graphviz.shutil.which", lambda name: None
    )
